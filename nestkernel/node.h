...
//  virtual double get_shouval_weight( double t, index sender_gid );
  virtual double shouval_update_weight( double t_start, double t_stop, double weight, double learn_rate,
                                        index sender_gid );
  virtual double shouval_update_weight( double t_start, double t_stop,
